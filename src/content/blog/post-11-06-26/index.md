...
We are also starting to open the door to expansion. Our team is actively speaking with new research groups eager to adopt the infrastructure, while simultaneously pursuing integration opportunities with other open-source infrastructure providers to see how we can interoperate and build a more connected scholarly network. A recent example is Kotahi’s role in the recently announced Open Science NL-funded project: [Next-generation publishing, advancing the Publish-Review-Curate model](https://www.nwo.nl/en/projects/xlemc16650), where eLife Pathways will work alongside researchers, institutes and technologists to create interoperable publishing technology.
